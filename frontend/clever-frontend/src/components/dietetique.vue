...
const loadFavorites = async () => {
    try {
        ...
        console.log("IDs favoris chargés :", favoriteIds.value)
    } catch (err) {
        console.error("Erreur chargement favoris :", err)
        if (!isAuthenticated.value) {
            loadGuestFavorites()
...
const isDietetiqueProduct = (product) => {
    const categoryName = getCategoryName(product)
    return String(categoryName)
        .trim()
        .toLowerCase()
        .normalize("NFD")
        .replace(/[\u0300-\u036f]/g, "") === "dietetique"
}
...
const loadProducts = async () => {
    try {
        ...
        console.log("Produits DIETETIQUE :", products.value)
    } catch (err) {
    ...
    <section class="products-section">
        <div class="container">
            ...
            <div v-else-if="error" class="products-message">
                ...
                <p>Impossible de charger les produits diététiques.</p>
            ...
            <div v-else class="products-message">
                <i class="fa-solid fa-utensils"></i>
                <p>Aucun produit diététique disponible pour le moment.</p>
            </div>
        </div>
    </section>
